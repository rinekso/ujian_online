...
<div class="row col-md-12">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <label for="pilih_mapel" class="col-md-3">
          Pilih Mapel
        </label>
<!--         <select id="pilih_mapel" class="form-control col-md-9" name="pilih_mapel">
 ...
 -->        <br>
        <br>
        <?php 
        // echo json_encode($p_mapel);
        echo form_dropdown("pilih_mapel", $p_mapel, $uri4, "id='pilih_mapel' class='form-control col-md-9'")."<br><br>";
...
<!--               <?php echo form_dropdown("id_mapel", $p_mapel, $uri4, "id='id_mapel' class='form-control col-md-9'");?>
 -->
            </td>
            </tr>
            <tr><?php if($this->session->userdata('admin_level') == "admin"){?><td class="" colspan="2">Guru</td><?php };?>
            <td>
            <?php
            if($this->session->userdata('admin_level') == "admin"){
            echo form_dropdown('id_guru', $p_guru, '', 'class="form-control" id="id_guru" required');
            }elseif($this->session->userdata('admin_level') == "guru"){
              ?>
              <input type="hidden" name="id_guru" id="id_guru" value="<?php echo $this->session->userdata('admin_konid');?>">
              <?php
            }?>
            </td></tr>
